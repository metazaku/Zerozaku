...
$Definition['EmailNotification'] = '%1$s, follow the link below to check it out:<br />
<a style="color: #0379BA" href="%2$s">%2$s</a>';
$Definition['EmailStoryNotification'] = '%1$s<br />
<br />
%3$s, follow the link below to check it out:<br />
<a style="color: #0379BA" href="%2$s">%2$s</a>';
